...
/**
 * This is the item provider adapter for a {@link fr.DockerV1.Image} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ImageItemProvider extends DockerObjectItemProvider {
	/**
	...
	protected void addRepositoryPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Image_repository_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Image_repository_feature",
								"_UI_Image_type"),
						DockerV1Package.Literals.IMAGE__REPOSITORY, true, false, false,
	...
	protected void addTagPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Image_tag_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Image_tag_feature", "_UI_Image_type"),
						DockerV1Package.Literals.IMAGE__TAG, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DockerV1Package.Literals.IMAGE__CONTAINER);
		}
	...
	public String getText(Object object) {
		String label = ((Image) object).getRepository();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(DockerV1Package.Literals.IMAGE__CONTAINER,
